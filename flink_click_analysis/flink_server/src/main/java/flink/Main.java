...
import flink.functions.ClickEventStatisticsCollector;
import flink.functions.CountingAggregator;
import flink.records.ClickEvent;
import flink.records.ClickEventDeserializationSchema;
import flink.records.ClickEventStatistics;
import flink.records.ClickEventStatisticsSerializationSchema;
        ...
        statistics.addSink(
                        JdbcSink.sink(
                                ...
                                new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                                        .withUrl("jdbc:mysql://localhost:3306/fastcampus_KafkaEcosystem_part5")
